...
namespace ML
{
    public class Usuario
    {
        ...
        [RegularExpression(@"/[aA-zZ0-9_.-]{1,50}/")]
        public string UserName { get; set; }

        [DisplayName("Email")]
        [Required(ErrorMessage = "El email es obligatorio")]
        [RegularExpression(@"/^[^\s@@]+@@[^\s@@]+\.[^\s@@]+{1,254}$/")]
        ...
        [RegularExpression(@"/(19[0-9]{2}|2[0-9]{3})/(0[1-9]|1[012])/([123]0|[012][1-9]|31)/")]
        ...
        [RegularExpression(@"/^(m|h|M|H){1,20}$/")]
